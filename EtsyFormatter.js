...
const Pendants =
  '743722532,743721308,757589125,724435341,956905038,708275794,775642205,954834035,939530500,798578012,812459087,710575432,757587697,800313771,788707399,711518670,757590925,725378803,761766712,775642033,732939021,719079064,725380327,757592605,788707659,722133413,802100228';
const Rings =
...
const separateData = (data, section) => {
  ...
  data.results.forEach((item, index) => {
    ...
    switch (section) {
      case 'earrings':
        fs.writeFileSync(
          'Listings/EtsyEarrings.json',
          JSON.stringify(earrings)
        );
        break;
      case 'pendants':
        fs.writeFileSync(
          'Listings/EtsyPendants.json',
